	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title">Edit Document Type</h3>
		 ...
		 <!-- Step wizard -->
		  <div class="box box-default">
			<div class="box-header with-border">
			  <h4 class="box-title">Edit Document Type</h4>
			</div>
			<!-- /.box-header -->
            ...
            @if ($message = Session::get('success'))
                    ...
                    @endif
				<form action="{{ url('update/document/'.$documents->id)}}" method="POST" enctype="multipart/form-data" class="tab-wizard wizard-circle">
                @csrf
					<!-- Step 1 -->
					<section>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="documentname" value="{{$documents->documentname}}" class="form-control" id="firstName5" required=""> </div>
							</div>
							<div class="col-md-6">
							<div class="form-group">
                                <label for="Location1">Document Related To Options</label>
									<select class="custom-select form-control" id="Location1" name="docoption">
										<option value="{{$documents->docoption}}">{{$documents->docoption}}</option>
                            ...
                            <div class="form-group">
                                <label for="Location1">Document Related To Departments</label>
									<select class="custom-select form-control" id="Location1" name="docdepartment">
										<option value="{{$documents->docdepartment}}">{{$documents->docdepartment}}</option>
