		 ...
		 <!-- Step wizard -->
		  <div class="box box-default">
            ...
            @if ($message = Session::get('success'))
                    ...
                    @endif
				<form action="{{ route('store.plot')}}" method="POST" enctype="multipart/form-data" class="tab-wizard wizard-circle">
                @csrf
					<!-- Step 1 -->
					<section>
						...
						<div class="row">
							...
							<div class="col-md-4">
                                ...
                                <input type="date" class="form-control" name="date" id="jobTitle5" required=""> 
                            </div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="propertyvalue" class="form-control" id="emailAddress1" required=""> </div>
							</div>
							<div class="col-md-6">
                            <div class="form-group">
									<label for="emailAddress1">PAI Rent</label>
									<input type="text" name="pairent" class="form-control" id="emailAddress1" required=""> </div>
							</div>
						</div>
                        ...
                        <div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="licensedpurpose" class="form-control" id="firstName5" required=""> </div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="lastName1">Application Number</label>
									<input type="text" name="applicationno" class="form-control" id="lastName1" required=""> </div>
							</div>
						</div>
                        ...
                        <div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="plotareasize" class="form-control" id="firstName5" required=""> </div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
                                <label for="jobTitle5">Finance Amount</label>
									<input type="text" class="form-control" name="financeamount" id="jobTitle5" required=""> </div>
							</div>
						</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="date" name="pai_lc_expiry" class="form-control" id="lastName1" required=""> </div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
                                <label for="jobTitle5">Attachment</label>
								<input type="file" class="form-control" name="pai_lc_attach" id="jobTitle5" required=""> </div>
							</div>
						</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="lastName1">Expiry Date</label>
									<input type="date" name="fi_expiry" class="form-control" id="lastName1" required=""> </div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
                                <label for="jobTitle5">Attachment</label>
								<input type="file" class="form-control" name="fi_attach" id="jobTitle5" required=""> </div>
							</div>
						</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
                                <label for="jobTitle5">Attachment</label>
								<input type="file" class="form-control" name="fl_attach" id="jobTitle5" required=""> </div>
							</div>
						</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="lastName1">Expiry Date</label>
									<input type="date" name="poa_moj_expiry" class="form-control" id="lastName1" required=""> </div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
                                <label for="jobTitle5">Issued To</label>
								<input type="text" class="form-control" name="poa_moj_issued_to" id="jobTitle5" required=""> </div>
							</div>
						</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="lastName1">Expiry Date</label>
									<input type="date" name="poa_warba_expiry" class="form-control" id="lastName1" required=""> </div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
                                <label for="jobTitle5">Issued to</label>
								<input type="text" class="form-control" name="poa_warba_issued_to" id="jobTitle5" required=""> </div>
							</div>
						</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="file" name="email_attach_newdeal" class="form-control" id="lastName1" required=""> </div>
							</div>
							
							<div class="col-md-6">
								<div class="form-group">
                                <label for="jobTitle5">POA</label>
								<input type="file" class="form-control" name="email_attach_poa" id="jobTitle5" required=""> </div>
							</div>
						</div>
