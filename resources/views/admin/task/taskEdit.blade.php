		 ...
		 <!-- Step wizard -->
		  <div class="box box-default">
            ...
            @if ($message = Session::get('success'))
                    ...
                    @endif
				<form action="{{ url('update/task/'.$tasks->id)}}" method="POST" enctype="multipart/form-data" class="tab-wizard wizard-circle">
                @csrf
					<!-- Step 1 -->
					<section>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" value="{{$tasks->taskdesc}}" name="taskdesc" class="form-control" id="firstName5" required=""> </div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="firstName5">Portfolio Number</label>
                                    <select class="custom-select form-control" id="Location1" name="portfolio">
                                        <option value="{{$tasks->portfolio}}">{{$tasks->portfolio}}</option>
							...
							<div class="col-md-6">
								<div class="form-group">
                                    ...
                                    <select class="custom-select form-control" id="Location1" name="client">
                                        <option value="{{$tasks->client}}">{{$tasks->client}}</option>
                            ...
                            <div class="col-md-6">
								<div class="form-group">
                                    ...
                                    <select class="custom-select form-control" id="Location1" name="plot">
                                        <option value="{{$tasks->plot}}">{{$tasks->plot}}</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
								<div class="form-group">
                                    ...
                                    <select class="custom-select form-control" id="Location1" name="doctype">
							           <option value="{{$tasks->doctype}}">{{$tasks->doctype}}</option>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="date" name="duedate" value="{{$tasks->duedate}}" class="form-control" id="firstName5"> </div>
							</div>
						</div>
